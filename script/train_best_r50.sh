...
TRAIN_OUTPUT=$(python train.py --encoder_name resnet50 --use_ema --augmentation_level advanced --comment "BEST" --epochs 100 --use_mixup --mixup_prob 0.3 --training_tomo_types denoised isonetcorrected)
echo "$TRAIN_OUTPUT"
