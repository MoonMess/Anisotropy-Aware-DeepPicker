...
# TRAIN_OUTPUT=$(python train.py --encoder_name df1 --comment "best_foctvy" --augmentation_level advanced --use_mean_std_shift --gradnorm_lr 1e-3 --loss_type focal_tversky)
# echo "$TRAIN_OUTPUT"
...
python -u run_experiment_evaluation.py \
    ...
    --experiment_names df1_se_20251025_233146_best_foctvy \
