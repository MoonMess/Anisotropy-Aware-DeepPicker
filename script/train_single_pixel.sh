...
echo "--- Démarrage de l'entraînement avec des masques d'un seul pixel ---"
TRAIN_OUTPUT=$(python train.py \
    --encoder_name resnet34 \
    --comment "single_pixel_w256" \
    --single_pixel_mask \
    --class_loss_weights 1.0 256.0 256.0 256.0 256.0 256.0 256.0 \
    --patch_size 96 96 96 \
    )
echo "$TRAIN_OUTPUT"
...
# Le post-traitement 'peak_local_max_gpu' est souvent un bon point de départ pour des
# cibles de type "point".
