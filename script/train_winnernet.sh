...
TRAIN_OUTPUT=$(python train.py --encoder_name winner_resnet50 --use_mixup --mixup_prob 0.5 --comment advanced_mixup05_rad04_deepreso --augmentation_level advanced --radius_fraction 0.4 --epochs 100)
echo "$TRAIN_OUTPUT"
